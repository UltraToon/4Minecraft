#
# THIS IS AN ARCHIVE VERSION OF THE SCRIPT
# THE MAIN DIFFERENCE IS IT ALLOWS YOU TO SELECT WHAT JAVA VERSION YOU WANT TO INSTALL
# HOWEVER TO MAKE IT USER FRIENDLY, IVE DECIDED IN THE NEW SCRIPT TO INSTALL ALL JAVA VERSIONS
# THIS IS DUE TO ATLAUNCHER BEING INSTANCE VARIETY.
